# -*- coding: utf-8 -*-
"""titanic_análise_intermdiária_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10mlgQUgahdmTrtAN1kMDMOpOPQw3nwqB
...
*   survival:	Sobreviventes 0 = Não, 1 = Sim
*   pclass:	Classe	1 = 1a, 2 = 2a, 3 = 3a
*   sex:	Sexo
*   Age:	Idade em anos
*   sibsp: Conjuguês abordo no Titanic
*   parch: Parentes abordo no Titanic children aboar/d the Titanic
...
# Insight 1: Mean: PassengerID (não importa) ; Survived (menor que 50%) ; PClass (tendendo pra 3a classe) ; Age (próximo dos 30) ; Sibsp(com 0 ou 1 conjugê) ; Parch (próximo de 0 acompanhantes) ;
...
* Aproveitamento de 100% do dataset em razão da manipulação dos dados e alvo com colunas do tipo numérica.
* Acurácia de 0.80
* Acurácia maior da regressão logística em relação à árvore de decisão ocorre em razão:
    * Regressão logística atua através de uma regressão linear, fornecendo um valor entre 0 e 1, visando encontrar uma relação entre os atributos e saída. Além disso, a árvore de decisão é aplicada a modelos de classificação ou regressão, devido a isto se torna mais generalista. O KNN se aplica através de um aprendizado supervisionado e visa notar o grau de similaridade de um vetor com os dados.
